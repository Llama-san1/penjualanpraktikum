                    ...
                    <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                        ...
                        <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="<?php echo site_url('/'); ?>">Laporan
                                    Pembelian</a>
                                <a class="nav-link" href="<?php echo site_url('/'); ?>">Laporan Stok</a>
                                <a class="nav-link" href="<?php echo site_url('/'); ?>">Stok Barang</a>
                                <a class="nav-link" href="<?php echo site_url('kustomer/laporan'); ?>">Kostumer</a>
                            </nav>
                        </div>
                    </nav>
                </div>
